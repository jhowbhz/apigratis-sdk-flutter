...
class ApiBrasil {
  ...
  ApiBrasil({
    ...
    ApiBrasilHooks? hooks,
  }) : http = ApiHttpClient(ApiBrasilConfig(
        ...
        auth = AuthService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        devices = DevicesService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        whatsapp = WhatsAppService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        evolution = EvolutionService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        whatsmeow = WhatsMeowService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        sms = SmsService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        dados = DadosService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        vehicles = VehiclesService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        fipe = FipeService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        correios = CorreiosService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        cep = CepService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        geolocation = GeolocationService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        geomatrix = GeomatrixService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        recognize = RecognizeService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        ddd = DddService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        holidays = HolidaysService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        translate = TranslateService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        weather = WeatherService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        loterias = LoteriasService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        databaseIp = DatabaseIpService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        consulta = ConsultaService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        ura = UraService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        chipVirtual = ChipVirtualService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        bulk = BulkService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        catalog = CatalogService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        account = AccountService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        payments = PaymentsService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        ipWhitelist = IpWhitelistService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        bearerRateLimit = BearerRateLimitService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
        ...
        reports = ReportsService(ApiHttpClient(ApiBrasilConfig(
          bearerToken: bearerToken,
          deviceToken: deviceToken,
          secretKey: secretKey,
          baseUrl: baseUrl,
  ...
  static Future<({ApiBrasil client, dynamic session})> login(
    ...
    if (session is Map && session['requires_2fa'] == true) {
      throw Exception('Esta conta exige autenticação em dois fatores. Use auth.login() + auth.verify2fa().');
    }
  ...
  }) => http.request(HttpMethod.values.byName(method.toLowerCase()), path, body: body, options: options);
