...
/// Catálogo de endpoints conhecidos da API Brasil.
class Catalog {
  /// Actions conhecidas da API de WhatsApp (POST /whatsapp/{action}).
  static const List<String> whatsappActions = [
    'addParticipant',
  ...
  static const List<String> evolutionPaths = [
    'call/offer',
  ...
  static const List<String> whatsmeowActions = [
    'chat/archive',
    'chat/mute',
    'chat/pin',
    'chat/unpin',
  ...
  static const List<String> consultaServicos = [
    'api-rntrc',
    'cep',
    'cnpj',
    'cpf',
  ...
  static const Map<String, ({String service, List<String> fields})> consultaTipos = {
    ...
    'consulta-ano-modelo': (
      service: 'veiculos',
      fields: ['codigoMarca', 'codigoModelo', 'codigoTabelaReferencia', 'codigoTipoVeiculo']
    ),
    ...
    'consulta-marca': (
      service: 'veiculos',
      fields: ['codigoTabelaReferencia', 'codigoTipoVeiculo']
    ),
    'consulta-modelo': (
      service: 'veiculos',
      fields: ['codigoMarca', 'codigoTabelaReferencia', 'codigoTipoVeiculo']
    ),
    ...
    'scpc-boa-vista': (service: 'cpf', fields: ['cpf']),
    'scpc-serasa': (service: 'cpf', fields: ['cpf']),
    ...
    'veiculos-total-async': (service: 'vehicles', fields: ['placa', 'webhook_url']),
  ...
  static const Map<String, List<String>> serviceActions = {
  ...
  /// Retorna metadados de um tipo de consulta (null se desconhecido).
  static ({String service, List<String> fields})? consultaTipo(String tipo) {
    return consultaTipos[tipo];
  }

  /// Retorna as actions documentadas de um serviço.
  static List<String> serviceActionsFor(String service) {
    return serviceActions[service] ?? const [];
  }
}
